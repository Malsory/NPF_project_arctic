...
df1 = pd.read_csv(r'C:\\Users\\Masloriy\\Desktop\\y_test_df.csv')
# df1 = pd.read_csv(r'C:\\Users\\Masloriy\\Desktop\\predictions_df.csv')
...
# max_date = pd.to_datetime('2019-06-15')
...
contour = plt.contourf(X, Y, blurred_df1, cmap=custom_cmap, levels=200)
ax = plt.gca()
...
plt.savefig('C:\\Users\\Masloriy\\Desktop\\y_test.png', dpi=100)
# plt.savefig('C:\\Users\\Masloriy\\Desktop\\predictions.png', dpi=100)
